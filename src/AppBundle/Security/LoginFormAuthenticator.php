...
class LoginFormAuthenticator extends AbstractFormLoginAuthenticator
{
     ...
     * User repository.
     *
     * @var \AppBundle\Repository\UsersRepository
     */
     ...
     *
     * @param \AppBundle\Repository\UsersRepository                                        $usersRepository   User entity repository
    ...
    {
        $this->userRepository = $em->getRepository(Users::class);
        $this->router = $router;
     ...
     *
     * @return \AppBundle\Entity\Users|null Result
     */
